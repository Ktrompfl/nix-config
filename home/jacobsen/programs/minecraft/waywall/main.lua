...
return function(cfg, remaps)
	...
	if cfg.e_count.enabled then
		helpers.res_mirror({
			src = cfg.e_count.show_c and { x = 1, y = 28, w = 49, h = 18 } or { x = 13, y = 37, w = 37, h = 9 },
	...
	waywall.listen("load", function()
		if cfg.debug_text then
			debug_text1 = waywall.text(debug_text, { x = 10, y = 10, color = "#FFFF00", size = 3 })
		...
		["Shift-I"] = function()
			...
			keybinds_text = waywall.text(
				"KEYBINDS:\n"
					...
					.. "\n"
					.. "Inc / Dec = "
					.. cfg.nbb.keys.increment
					.. " / "
					.. cfg.nbb.keys.decrement
					.. "\n"
					.. "Reset = "
					.. cfg.nbb.keys.reset
					.. "\n",
